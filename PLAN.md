...
- [x] Обновить README.md с инструкциями по настройке API ключей
- [x] Добавить комментарии в код
- [x] Документировать структуру API endpoints
- [x] Добавить примеры использования

**Выполнено:**
- README.md обновлен с подробными инструкциями по настройке OpenRouter API
- Добавлены комментарии в утилиты (`lib/openrouter.ts`, `lib/cache.ts`, `lib/imageOptimization.ts`)
- Добавлены комментарии в API routes (промпты, обработка запросов)
- Создана документация по тестированию (`TESTING.md`)
- Создан обзор кода (`CODE_REVIEW.md`)
- Создана полная документация по API endpoints (`API.md`):
  - Описание всех трех endpoints (`/api/describe`, `/api/exhibition`, `/api/poster`)
  - Структура запросов и ответов
  - Примеры использования (PowerShell curl, JavaScript/Fetch)
  - Типы данных и интерфейсы
  - Ограничения и лимиты
  - Обработка ошибок
  - Примеры полного цикла работы с API
...
- текстовое сопровождение для каталога
```

#### Промпт для названия выставки
```
На основе следующих описаний картин предложи 3 варианта поэтичного названия для выставки:
[описания картин]
