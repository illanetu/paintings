...
### 1. Настройка AI API
- [ ] Выбрать AI провайдера (OpenAI GPT-4 Vision / Anthropic Claude / Google Gemini)
- [ ] Установить необходимые пакеты (например, `openai` или `@anthropic-ai/sdk`)
- [ ] Создать файл `.env.local` для хранения API ключей
